        ...
        if vertex not in visited:
            ...
            for next_vertex, direction, _ in problem.getSuccessors(vertex):
                if next_vertex not in visited:
                    stack.push((next_vertex, directions + [direction]))
    ...
    while not queue.isEmpty():
        ...
        if vertex not in visited:
            ...
            for next_vertex, action, _ in problem.getSuccessors(vertex):
                if next_vertex not in visited:
                    queue.push((next_vertex, actions + [action]))
    ...
    while not p_queue.isEmpty():
        ...
        if vertex not in visited:
            ...
            for next_vertex, direction, cost in problem.getSuccessors(vertex):
                if next_vertex not in visited:
                    t_directions = directions + [direction]
                    p_queue.push((next_vertex, t_directions, total_cost + cost), total_cost + cost)
    ...
    while not p_queue.isEmpty():
        ...
        if vertex not in visited:
            ...
            for next_vertex, direction, cost in problem.getSuccessors(vertex):
                if next_vertex not in visited:
                    p_queue.push(
                        (next_vertex, directions + [direction], total_cost + cost),
                        total_cost + cost + heuristic(next_vertex, problem)
                    )
